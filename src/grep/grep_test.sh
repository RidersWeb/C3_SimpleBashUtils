...
TEMPLATE="yes"
PATTERN="test_files/grep_pattern.txt"
TEMPLATE_FILE="test_files/grep_test.txt"
TEST_FILE="test_files/grep_test.txt"
S21="./s21_grep"
GREP="grep.txt"
...
# поиск строк, содержащих шаблон в файле для тестирования и файле s21_grep.h, вывод в файл
